...
def main():
    ...
    textLine = []
    compare = [0,0,0,0,0,0]
    compare2 = [0,0,0,0,0,0]
    title=["file","mzp","ma0","LHAID","tanBeta","process"]
    for a in hAList:
        compare[0] = "lhafile"
        if (int(a.mzp) != 0):
            compare[1] = a.mzp
        ...
        if (a.gener != 0):
            compare[5] = a.gener
        if (int(compare[1])!=0 and int(compare[2])!=0 and int(compare[3])!=0 and int(compare[4])!=0):
            for b in hAList2:
                print(compare)
                print(b.mzp2, b.ma02, b.lhaid2, b.tanbeta2)
                print(b.gener2)
                
                flag = False
                if (int(b.mzp2)==int(compare[1]) and int(b.ma02)==int(compare[2]) and int(b.lhaid2)==int(compare[3]) and int(b.tanbeta2)==int(compare[4]) and b.gener2==compare[5]):
                    compare2 = ["cards", b.mzp2, b.ma02, b.lhaid2, b.tanbeta2, b.gener2]
                    print(123)
